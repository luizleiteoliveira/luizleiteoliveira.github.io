...
| 4  | **Esse código está com erro, vê se arruma:**<br>```python<br>def fatorial(n):<br>    return n * fatorial(n)<br>```                                                                                                                                                                                     | Falta indicar o objetivo e o erro esperado (loop infinito). | **Esse código deveria calcular o fatorial de um número, mas entra em recursão infinita. Pode corrigir e explicar o erro?**<br>```python<br>def fatorial(n):<br>    return n * fatorial(n)<br>```                                                                                                                                                                                                           |
